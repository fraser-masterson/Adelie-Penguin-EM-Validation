...
# VANTAGE output (OUT) file
out_file = read_csv(paste0('data/em_labelled_files/', penguin, '_25Hz_EM_classifications_OUT.csv', sep = ''))

# Original EM-labelled accelerometry file
em_file = read_csv(paste0('data/em_labelled_files/', penguin, '_25Hz_EM_classifications.csv', sep = ''))
...
# Resetting the OUT file for the next video
out_file_new = out_file
out_file_new$PCE = 0
out_file_new = out_file_new[-6]
write_csv(out_file_new, file = paste0('data/em_labelled_files/', penguin, '_25Hz_EM_classifications_OUT.csv', sep = '')) 